  ...
  <main>
    ...
    <div class="content">
      ...
      <section class="route" id="route-rubric">
        ...
        <div class="widget">
          <p class="help" style="margin-bottom:14px"><strong>Suggested judging-floor flow.</strong> Pulls from this app + <code>demo.sh</code>; survives an offline laptop via recorded screenshots.</p>
